  ...
  return (
    <div>
      <div className="ds-page-title">
        <h1>Typography</h1>
        <p>token.json의 typo 토큰 (font · font-weight · letter-spacing).</p>
      </div>
      ...
      <section className="ds-section">
        <h2 className="ds-section__title">Font Weight</h2>
              ...
              <tr key={w.path}>
                ...
                <td
                  ...
                  style={{
                    fontFamily: family,
                    fontWeight:
                      w.name === 'bold' ? 700 : w.name === 'medium' ? 500 : 400,
                  }}
                >
      ...
      <section className="ds-section">
        <h2 className="ds-section__title">Letter Spacing</h2>
        <table className="ds-type-table">
          <tbody>
            <tr>
